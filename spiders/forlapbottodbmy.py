...
def insert(website,crdate,kode,nama, link_detail, prov,kategori,status,jml_dosen_tetap_1718, jml_mhs_1718 , rasio_dosen_mhs_1718, jml_dosen_tetap_1819, jml_mhs_1819 , rasio_dosen_mhs_1819):
    ...
    #fieldnames = ['kode','nama', 'link_detail', 'prov','kategori','status','jml_dosen_tetap_1718', 'jml_mhs_1718' , 'rasio_dosen_mhs_1718', 'jml_dosen_tetap_1819', 'jml_mhs_1819' , 'rasio_dosen_mhs_1819']
    """create table forlap_header(
        id int not null auto_increment primary key, 
        kode varchar(100)  null, 
        nama varchar(200) null, 
        link_detail varchar(200) null,
        prov varchar(100)  null, 
        kategori varchar(100)  null, 
        status varchar(100)  null,
        jml_dosen_tetap_1718 varchar(10)  null,
        jml_mhs_1718 varchar(10)  null,
        rasio_dosen_mhs_1718 varchar(10)  null,
        jml_dosen_tetap_1819 varchar(10)  null,
        jml_mhs_1819 varchar(10)  null,
        rasio_dosen_mhs_1819 varchar(10)  null,
    ...
    sql = """ 
    INSERT INTO forlap_header (crawl_date, kode,nama, link_detail, prov,kategori,status,jml_dosen_tetap_1718, jml_mhs_1718 , rasio_dosen_mhs_1718, jml_dosen_tetap_1819, jml_mhs_1819 , rasio_dosen_mhs_1819) 
...
def update(id,website,crdate,kode,nama, link_detail, prov,kategori,status,jml_dosen_tetap_1718, jml_mhs_1718 , rasio_dosen_mhs_1718, jml_dosen_tetap_1819, jml_mhs_1819 , rasio_dosen_mhs_1819):
    mysqldb = mysql.connector
    """ Insert with cek if exists"""
    sql = """ 
    UPDATE forlap_header 
    SET crawl_date=%s, kode=%s,nama=%s, link_detail=%s, prov=%s,kategori=%s,status=%s,jml_dosen_tetap_1718=%s, jml_mhs_1718 =%s, rasio_dosen_mhs_1718=%s, jml_dosen_tetap_1819=%s, jml_mhs_1819 =%s, rasio_dosen_mhs_1819=%s
    WHERE id=%s
    ;"""
    conn = None
    vendor_id = None
    try:
        ...
        cur = conn.cursor()
        # execute the INSERT statement
        cur.execute(sql, (crdate,kode,nama, link_detail, prov,kategori,status,jml_dosen_tetap_1718, jml_mhs_1718 , rasio_dosen_mhs_1718, jml_dosen_tetap_1819, jml_mhs_1819 , rasio_dosen_mhs_1819,id))
        # get the generated id back
        #vendor_id = cur.fetchone()[0]
        vendor_id = cur.lastrowid
        # commit the changes to the database
